...
func (o *OperationLogDao) GetOperationLogList(ctx context.Context, condition *OperationLogCondition) ([]*model.SysOperationLog, int64, error) {
...
func (o *OperationLogDao) ResourceIDScope(resourceID int64) func(tx gen.Dao) gen.Dao {
	return func(tx gen.Dao) gen.Dao {
		if resourceID <= 0 {
			return tx
		}

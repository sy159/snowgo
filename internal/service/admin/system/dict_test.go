...
func (m *mockDictRepo) GetDictById(_ context.Context, _ int32) (*model.SysDict, error) {
	if m.dict == nil {
...
func (m *mockDictRepo) GetDictList(_ context.Context, _ *daoSystem.DictListCondition) ([]*model.SysDict, int64, error) {
	if m.dict == nil {
		return nil, 0, m.err
	}
	return []*model.SysDict{m.dict}, 1, m.err
}
...
func (m *mockDictRepo) TransactionCreateDict(_ context.Context, _ *query.Query, dict *model.SysDict) (*model.SysDict, error) {
	dict.ID = 1
	return dict, m.err
}

func (m *mockDictRepo) TransactionUpdateDict(_ context.Context, _ *query.Query, dict *model.SysDict) (*model.SysDict, error) {
	return dict, m.err
}
...
func (m *mockDictRepo) GetItemListByDictCode(_ context.Context, _ string) ([]*model.SysDictItem, error) {
	return m.dictItems, m.err
}

func (m *mockDictRepo) TransactionCreateDictItem(_ context.Context, _ *query.Query, item *model.SysDictItem) (*model.SysDictItem, error) {
	item.ID = 1
	return item, m.err
}

func (m *mockDictRepo) GetDictItemById(_ context.Context, _ int32) (*model.SysDictItem, error) {
	if m.dictItem == nil {
		return nil, gorm.ErrRecordNotFound
	}
...
func (m *mockDictRepo) TransactionUpdateDictItem(_ context.Context, _ *query.Query, item *model.SysDictItem) (*model.SysDictItem, error) {
	return item, m.err
}
...
func TestUpdateDict_DuplicateCode(t *testing.T) {
	...
	svc := &DictService{
		dictRepo: &mockDictRepo{
			isDictDup: true,
			dict:      &model.SysDict{ID: 1, Code: "x", Name: name, CreatedAt: ptrTimeSys(time.Now())},
		},
	}
...
func TestGetItemListByCode_EmptyResultsCacheShortTTL(t *testing.T) {
	...
	svc := &DictService{
		dictRepo: &mockDictRepo{dictItems: []*model.SysDictItem{}},
		cache:    &mockDictCache{data: cacheData},
	}

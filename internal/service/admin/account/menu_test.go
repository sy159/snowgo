...
func (m *mockMenuDao) GetById(_ context.Context, _ int32) (*model.SysMenu, error) {
	if m.menu == nil {
...
func (m *mockMenuDao) GetByParentId(_ context.Context, _ int32) ([]*model.SysMenu, error) {
	return m.parentMenus, m.err
}

func (m *mockMenuDao) GetAllMenus(_ context.Context) ([]*model.SysMenu, error) {
...
func (m *mockMenuDao) TransactionUpdateMenu(_ context.Context, _ *query.Query, menu *model.SysMenu) (*model.SysMenu, error) {
	return menu, nil
}
...
func TestGetMenuTree_EmptyMenus(t *testing.T) {
	...
	svc := &MenuService{
		menuDao: &mockMenuDao{menus: []*model.SysMenu{}},
		cache:   &mockCache{data: cacheData},
	}

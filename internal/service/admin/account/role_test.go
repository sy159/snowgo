...
func (m *mockRoleDao) GetRoleById(_ context.Context, _ int32) (*model.SysRole, error) {
	if m.role == nil {
...
func (m *mockRoleDao) GetRoleList(_ context.Context, _ *daoAccount.RoleListCondition) ([]*model.SysRole, int64, error) {
	if m.role == nil {
		return nil, 0, m.err
	}
	return []*model.SysRole{m.role}, 1, m.err
}
...
func (m *mockRoleDao) GetMenuListByRoleId(_ context.Context, _ int32) ([]*model.SysMenu, error) {
...
func (m *mockRoleDao) TransactionCreateRole(_ context.Context, _ *query.Query, role *model.SysRole) (*model.SysRole, error) {
	role.ID = 1
	return role, nil
}

func (m *mockRoleDao) UpdateRole(_ context.Context, role *model.SysRole) (*model.SysRole, error) {
	return role, nil
}

func (m *mockRoleDao) TransactionCreateRoleMenu(_ context.Context, _ *query.Query, _ []*model.SysRoleMenu) error {
	return nil
}
...
func TestUpdateRole_DuplicateCode(t *testing.T) {
	...
	name := "Test"
	svc := &RoleService{
		roleDao:    &mockRoleDao{codeExists: true, role: &model.SysRole{ID: 1, Code: "x", Name: &name}},
		logService: logWriter,
	}

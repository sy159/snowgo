...
func (m *mockUserDao) GetUserById(_ context.Context, _ int32) (*model.SysUser, error) {
	if m.user == nil {
...
func (m *mockUserDao) GetUserByUsername(_ context.Context, _ string) (*model.SysUser, error) {
	if m.user == nil {
		return nil, gorm.ErrRecordNotFound
	}
	return m.user, m.err
...
func (m *mockUserDao) GetRoleListByUserId(_ context.Context, _ int32) ([]*model.SysRole, error) {
...
func (m *mockUserDao) GetUserList(_ context.Context, _ *daoAccount.UserListCondition) ([]*model.SysUser, int64, error) {
	if m.user == nil {
		return nil, 0, m.err
	}
	return []*model.SysUser{m.user}, 1, m.err
}

func (m *mockUserDao) TransactionCreateUser(_ context.Context, _ *query.Query, user *model.SysUser) (*model.SysUser, error) {
	user.ID = 1
	return user, m.err
}
...
func (m *mockUserDao) TransactionCreateUserRoleInBatches(_ context.Context, _ *query.Query, _ []*model.SysUserRole) error {
	return m.err
}
...
func TestGetUserById_Success(t *testing.T) {
	u := testUser()
	roles := []*model.SysRole{{ID: 1, Code: "admin", Name: ptrStr("Admin")}}

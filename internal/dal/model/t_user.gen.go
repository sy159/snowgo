...
type User struct {
	...
	Username     *string          `gorm:"column:username;type:varchar(20);index:idx_username,priority:1" json:"username"`
	Password     *string          `gorm:"column:password;type:varchar(64)" json:"password"`
	Tel          string           `gorm:"column:tel;type:varchar(20);not null;uniqueIndex:idx_tel,priority:1" json:"tel"`

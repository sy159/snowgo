...
type SysOperationLog struct {
	...
	ResourceID   int64      `gorm:"column:resource_id;type:bigint(20);not null;index:idx_resource,priority:2;comment:资源ID，如 user 表的主键 ID" json:"resource_id"` // 资源ID，如 user 表的主键 ID
